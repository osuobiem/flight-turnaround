...
class TeamsTaskModuleBot extends TeamsActivityHandler {
    ...
    handleTeamsTaskModuleFetch(context, taskModuleRequest) {
        ...
        } else if (cardTaskFetchValue === TaskModuleIds.UpdateTask) {
            taskInfo.url = taskInfo.fallbackUrl = this.baseUrl + '/' + TaskModuleIds.UpdateTask + '.html';
            this.setTaskInfo(taskInfo, TaskModuleUIConstants.CustomForm);
        } else if (cardTaskFetchValue === TaskModuleIds.ViewActivity) {
            taskInfo.url = taskInfo.fallbackUrl = this.baseUrl + '/' + TaskModuleIds.ViewActivity + '.html';
            this.setTaskInfo(taskInfo, TaskModuleUIConstants.CustomForm);
        }
