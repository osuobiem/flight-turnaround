    ...
    const [rows, setRows] = useState([
        {
            ...
            items: [
                ...
                { key: "1-4", content: <MgtTeamsMenu title="Edit Flight Ops Lagos" key={1} />, style: {justifyContent: 'right'} },
            ],
        },
        {
            key: 2,
            items: [
                ...
                { key: "2-4", content: <MgtTeamsMenu title="Edit Abuja - Flight Ops" key={2} />, style: {justifyContent: 'right'} },
            ],
        },
        {
            key: 3,
            items: [
                ...
                { key: "3-4", content: <MgtTeamsMenu title="Edit Ilorin - Flight Ops" key={3} />, style: {justifyContent: 'right'} },
            ],
        },
        {
            key: 4,
            items: [
                ...
                { key: "4-4", content: <MgtTeamsMenu title="Edit Benin - Flight Ops" key={4} />, style: {justifyContent: 'right'} },
            ],
        },
        {
            key: 5,
            items: [
                ...
                { key: "5-4", content: <MgtTeamsMenu title="Edit Akure - Flight Ops" key={5}  />, style: {justifyContent: 'right'} },
            ],
        },
    ]);

    let contentRows = [...rows].map(row => {
        return {
            key: row.key,
            items: [...row.items].map((item, i) => {
                return i != row.items.length - 1 ? { ...item } : {
                    ...item,
                    content: <MgtTeamsMenu title={`Edit ${row.items[0].content}`} key={item.key} rows={rows} setRows={setRows} />
                }
            })
        }
    });
